---
title: "Top U.S. airline compamies: Stocks performance"
author: "Elior Bliah"
...
prices$symbol[prices$symbol == "AAL"] <- "American airlines"
prices$symbol[prices$symbol == "DAL"] <- "Delta"
prices$symbol[prices$symbol == "UAL"] <- "United airlines"
prices$symbol[prices$symbol == "LUV"] <- "Southwest Airlines"
...
id_companies <- c(68568,231789,219075,205563)
