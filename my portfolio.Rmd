...
tickers <- c('INTC','JETS','IBCD.DE','SPEN.TA', 'ELWS.TA',
             'WIX','SE', 'QQQ','SPY','ENLT.TA','SEDG')
...
buy<-data.frame(symbol = c("AYX","INTC","JETS","WIX","SPEN.TA","IBCD.DE","MMM","SGOL","SE",
                           
                           "SEDG"), 
                 buy_date = c(AYX_BD,INTC_BD,JETS_BD,WIX_BD,SPEN.TA_BD,IBCD.DE_BD,SGOL_BD, MMM_BD,SE_BD, SEDG_BD),
                buy_price = c(AYX,INTC,JETS,WIX,SPEN.TA,IBCD.DE, MMM, SGOL,SE,SEDG)
               )
