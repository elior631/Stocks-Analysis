---
title: "Top Video Game companies in Wall St."
author: "Elior Bliah"
...
```{r include=FALSE}
tickers <- c("EA","NTDOY","SCPL","TTWO","SE","BILI")
...
prices$symbol[prices$symbol == "EA"] <- " Electronic Arts Inc."
prices$symbol[prices$symbol == "NTDOY"] <- "Nintendo Co."
prices$symbol[prices$symbol == "SCPL"] <- "SciPlay Corp."
prices$symbol[prices$symbol == "TTWO"] <- "Take-Two Interactive Software Inc."
prices$symbol[prices$symbol == "SE"] <- "Sea Ltd."
prices$symbol[prices$symbol == "BILI"] <- "Bilibili Inc."
...
**Bilibili Inc.**: Bilibili is a China-based provider of online entertainment services. The company offers a platform offering videos, live broadcasting, mobile games, animation, and comics. Bilib0.
ili recently announced that it has entered into a three-year strategic partnership with Riot Games, developer of the leading multiplayer online battle arena (MOBA) game League of Legends. The partnership gives Bilibili the rights to live broadcast the League of Legend Esports global events.

**Sea Ltd.**: Sea is an internet and mobile platform company. It provides online gaming services, manages third-party online marketplaces, and provides various financial services, such as e-wallet and payments services. Sea reported a net loss of 393.5 million dollar in Q2 2020 ended June 30, 2020, compared to a net loss of $280.1 million in the year-ago quarter. Revenue growth of 102.2% for the quarter was offset by soaring operating costs and a 82.1% rise in income tax expense
...
The sharpe ratio was calculated from 2018 on monthly basis
...
*note*: can't get SEA Lts and bilbilbil financials
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
id_companies <- c(372651,965743,372538, 1011098)
