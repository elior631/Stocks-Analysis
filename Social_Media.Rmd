...
prices$symbol[prices$symbol == "FB"] <- "Facebook"
prices$symbol[prices$symbol == "TWTR"] <- "Twitter"
prices$symbol[prices$symbol == "PINS"] <- "Pinterest"
prices$symbol[prices$symbol == "SNAP"] <- "Snap Inc"
...
id_companies <- c(121021,30388,979810,449958)
